...
export function createReplayFixManifest(
  ...
  return {
    ...
    instructions: [
      ...
      "Treat .github/**, CODEOWNERS, .env*, lockfiles, deployment/infrastructure configuration, and authentication or security policy files as protected paths. Do not change them unless the issue explicitly requires it and a person confirms that exact path in the approval step.",
